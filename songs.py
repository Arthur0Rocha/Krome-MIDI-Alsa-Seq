niver_re_20220813 = [
    {"name": 'Separate ways',         "tones": ['PF007'],                               "pd": '-Y',     "at": '+Y'}, # 01
    {"name": 'Machine head',          "tones": ['PF000', 'CD000'],                      "pd": '-Y',     "at": '+Y'}, # 02
    {"name": 'Stay',                  "tones": ['PF020', 'PF019', 'PF018'],             "pd": '-Y',     "at": '+Y'}, # 03
    {"name": 'Rolling in the deep',   "tones": ['PF002'],                               "pd": '-Y',     "at": '+Y'}, # 04
    {"name": 'Whats up',              "tones": ['PF000', 'PE001'],                      "pd": '-Y',     "at": '+Y'}, # 05
    {"name": 'Take on me',            "tones": ['CD026'],                               "pd": '-Y',     "at": '+Y'}, # 06
    {"name": 'In between days',       "tones": ['PF001'],                               "pd": '-Y',     "at": '+Y'}, # 07
    {"name": 'Everybody wants...',    "tones": ['CD031'],                               "pd": '-Y',     "at": '+Y'}, # 08
    {"name": 'Zombie',                "tones": ['CD001PM', 'PA020'],                    "pd": '-Y',     "at": '+Y'}, # 09
    {"name": 'Silent morning',        "tones": ['PF000', 'PF008', 'PF010', 'PF009'],    "pd": '-Y',     "at": '+Y'}, # 10
    {"name": 'Bring me to life',      "tones": ['CD001', 'PF001'],                      "pd": '-Y',     "at": '+Y'}, # 11
    {"name": 'Jeremy',                "tones": ['PF000'],                               "pd": '-Y',     "at": '+Y'}, # 12
    {"name": 'The final count...',    "tones": ['CD018'],                               "pd": '-Y',     "at": '+Y'}, # 13
    {"name": 'My sacrifice',          "tones": ['PF000', 'PA092'],                      "pd": '-Y',     "at": '+Y'}, # 14
    {"name": 'Numb',                  "tones": ['CD028', 'PA020', 'PF001', 'CD001PM'],  "pd": '-Y',     "at": '+Y'}, # 15
    {"name": 'Girls just want to...', "tones": ['PF005', 'CD006', 'PE002'],             "pd": '-Y',     "at": '+Y'}, # 16
    {"name": 'Tears of the d...',     "tones": ['PF008', 'PF006', 'PF001', 'PF000'],    "pd": '-Y',     "at": '+Y'}, # 17
    {"name": 'Blinding lights',       "tones": ['CD006', 'PF008', 'PF010', 'PF009'],    "pd": '-Y',     "at": '+Y'}, # 18
    {"name": 'I want out',            "tones": ['CD000', 'PF001', 'PF013'],             "pd": '-Y',     "at": '+Y'}, # 19
    {"name": 'Wasting love',          "tones": ['PF001', 'CD001PM', 'PF000'],           "pd": '-Y',     "at": '+Y'}, # 31
    {"name": 'I don\'t wanna m...',   "tones": ['CD027'],                               "pd": '-Y',     "at": '+Y'}, # 21
    {"name": 'Always',                "tones": ['CD035', 'PA092'],                      "pd": '-Y',     "at": '+Y'}, # 22
    {"name": 'Teto de vidro',         "tones": ['CD006', 'PF001', 'CD029'],             "pd": '-Y',     "at": '+Y'}, # 23
    {"name": 'Admirável chip...',     "tones": ['PF001'],                               "pd": '-Y',     "at": '+Y'}, # 24
    {"name": 'Memórias',              "tones": ['PF000', 'CD029'],                      "pd": '-Y',     "at": '+Y'}, # 25
    {"name": 'Déjà vu',               "tones": ['PF000', 'CD029'],                      "pd": '-Y',     "at": '+Y'}, # 26
    {"name": 'Eu quero sempre',       "tones": ['PF004', 'PF003', 'PF001'],             "pd": '-Y',     "at": '+Y'}, # 27
    {"name": 'Máscara',               "tones": ['PF001'],                               "pd": '-Y',     "at": '+Y'}, # 28
    {"name": 'Anacrônico',            "tones": ['CD022', 'PF001'],                      "pd": '-Y',     "at": '+Y'}, # 29
    {"name": 'Pulsos',                "tones": ['PF000'],                               "pd": '-Y',     "at": '+Y'}, # 30
    {"name": 'Me adora',              "tones": ['PF000', 'CD029'],                      "pd": '-Y',     "at": '+Y'}, # 31
    {"name": 'Equalize',              "tones": ['PF000', 'PF003'],                      "pd": '-Y',     "at": '+Y'}, # 32
    {"name": 'Na sua estante',        "tones": ['PD020', 'CD001'],                      "pd": '-Y',     "at": '+Y'}, # 33
    {"name": 'Semana que vem',        "tones": ['CD029'],                               "pd": '-Y',     "at": '+Y'}, # 34
    {"name": 'I wanna be',            "tones": ['PF000', 'CD000'],                      "pd": '-Y',     "at": '+Y'}, # 35
]
...
casamento_20220409 = [
    ...
    {"name": 'It\'s my life',         "tones": ['CD020', 'PD084'],                     "pd": 'SW'             }, # 15
    {"name": 'The trooper',           "tones": ['PF000'],                              "pd": 'SW'             }, # 16
    {"name": 'Highway to hell',       "tones": ['PA092', 'PF000']                                             }, # 17

    {"name": 'I don\'t wanna m...',   "tones": ['CD027']                                                      }, # 18
]
...
ensaioBoituva_20220312 = [
    ...
    {"name": 'Always',                "tones": ['CD035'],                              "pd": '-Y',  "at": '+Y'}, # 14
    {"name": 'Crush...',              "tones": ['PA019', 'CD029', 'PF001', 'PD014'],   "pd": 'SW',  "at": '+Y'}, # 15
...
area86_20220305 = [
    ...
    {"name": 'Wicked game',           "tones": ['PF001', 'PF000', 'PF010', 'CD029'],   "pd": 'SW'             }, # 02
    {"name": 'Stay',                  "tones": ['PF020', 'PF019', 'PF018']                                    }, # 03
    {"name": 'Everybody wants...',    "tones": ['CD031']                                                      }, # 04
    {"name": 'Man in the box',        "tones": ['PF011', 'CD029'],                     "pd": 'SW'             }, # 05
    {"name": 'Machine head',          "tones": ['PF000', 'CD000']                                             }, # 06
    {"name": 'My sacrifice',          "tones": ['PF000']                                                      }, # 07
    {"name": 'Jeremy',                "tones": ['PF000'],                              "pd": '+Y'             }, # 08
    {"name": 'Whats up',              "tones": ['PF000', 'PE001'],                     "pd": 'SW'             }, # 09
    {"name": 'Girls just want to...', "tones": ['PF005', 'CD006', 'PE002'],            "pd": 'SW'             }, # 10
    {"name": 'Numb',                  "tones": ['CD028', 'PA020', 'PF001', 'CD001PM'], "pd": 'SW'             }, # 11
    {"name": 'Bring me to life',      "tones": ['CD001', 'PF001'],                     "pd": 'SW'             }, # 12
    {"name": 'Admirável chip...',     "tones": ['PF001'],                              "pd": '-Y',  "at": '+Y'}, # 13
    {"name": 'Perfect strangers',     "tones": ['CD022PP', 'CD022PM', 'PA092'],        "pd": 'SW'             }, # 14
    {"name": 'Tears of the d...',     "tones": ['PF008', 'PF006', 'PF001', 'PF000'],   "pd": 'SW'             }, # 15
    {"name": 'Separate ways',         "tones": ['PF007']                                                      }, # 16
    {"name": 'Maniac',                "tones": ['CD025'],                              "pd": '-Y',  "at": '+Y'}, # 17
    {"name": 'Nothing else m...',     "tones": ['PF001', 'CD000']                                             }, # 18
    {"name": 'Até quando esperar',    "tones": ['PF004', 'PF010'],                     "pd": 'SW'             }, # 19
    {"name": 'Take on me',            "tones": ['CD026']                                                      }, # 20
    {"name": 'Mama, I\'m coming...',  "tones": ['CD024', 'PA092'],                     "pd": '-Y',  "at": '+Y'}, # 21
    {"name": 'Plush',                 "tones": ['PF000', 'PA092'],                     "pd": '+Y'             }, # 22
    {"name": 'I don\'t wanna m...',   "tones": ['CD027']                                                      }, # 23
    {"name": 'Toxicity',              "tones": ['PF001', 'CD001']                                             }, # 24
    {"name": 'Love ain\'t no...',     "tones": ['PF008', 'PF000'],                     "pd": 'SW'             }, # 25
    {"name": 'Zombie',                "tones": ['CD001PM', 'PA020']                                           }, # 26
    {"name": 'Jump',                  "tones": ['PF007', 'PF001']                                             }, # 27
    {"name": 'Sweet child',           "tones": ['PF000', 'CD029', 'CD000'],            "pd": 'SW'             }, # 28
    {"name": 'Highway to hell',       "tones": ['PF003', 'PF000']                                             }, # 29
    {"name": 'The evil that...',      "tones": ['PD057', 'PF000'],                     "pd": 'SW'             }, # 30
    {"name": 'Mr. Crowley',           "tones": ['PB011', 'CD016', 'CD017'],            "pd": 'SW'             }, # 31

    # Extras
    {"name": 'Máscara',               "tones": ['PF001', 'CD001'],                     "pd": 'VOL', "at": '+Y'}, # 32
    {"name": 'Breaking the law',      "tones": ['PF000', 'CD000']                                             }, # 33
    {"name": 'Enjoy the silence',     "tones": ['CD019']                                                      }, # 34
]
...
refugio_20211008 = [
    # Parte 1
    {"tones": ['PF001', 'PF000', 'PF010', 'CD029'], "name": 'Wicked game', "pd": 'SW'}, # 01
    {"tones": ['PF000'], "name": 'Machine head'}, # 02
    {"tones": ['CD031'], "name": 'Everybody wants...'}, # 03
    {"tones": ['PA092'], "name": 'I love rock n roll', "pd": 'SW'}, # 04
    {"tones": ['PF005', 'CD006', 'PE002'], "name": 'Girls just want to...', "pd": 'SW'}, # 05
    {"tones": ['PF008', 'PF006', 'PF001', 'PF000'], "name": 'Tears of the d...', "pd": 'SW'}, # 06
    {"tones": ['PF000', 'PE001'], "name": 'Whats up', "pd": 'SW'}, # 07
    {"tones": ['CD028', 'PA020', 'PF001', 'CD001PM'], "name": 'Numb', "pd": 'SW'}, # 08 
    {"tones": ['CD026'], "name": 'Take on me'}, # 09
    {"tones": ['CD019'], "name": 'Enjoy the silence'}, # 10
    {"tones": ['CD006', 'PF001', 'CD029'], "name": 'Teto de vidro', "pd": 'SW'}, # 11
    {"tones": ['PF000', 'CD029'], "name": 'Pulsos'}, # 12
    {"tones": ['PD020', 'CD001PM', 'CD001PP'], "name": 'Na sua estante'}, # 13
    {"tones": ['CD001', 'PF001'], "name": 'Bring me to life', "pd": 'SW'}, # 14
    {"tones": ['PF000', 'PF001', 'PF003', 'PF004'], "name": 'Don\'t speak', "pd": 'SW', "at": '+Y'}, # 15
    {"tones": ['PF011', 'CD029'], "name": 'Man in the box', "pd": 'SW'}, # 16
    {"tones": ['PF004', 'PF010'], "name": 'Até quando esperar', "pd": 'SW'}, # 17
    ...
    {"tones": ['PF000'], "name": 'Breaking the law'}, # 23
    {"tones": ['PF008', 'PF000'], "name": 'Love ain\'t no...', "pd": 'SW'}, # 24
    {"tones": ['CD025'], "name": 'Maniac', "pd": '-Y', "at": '+Y'}, # 25
    {"tones": ['PF001', 'CD001'], "name": 'Toxicity'}, # 26
    {"tones": ['CD024', 'PA092'], "name": 'Mama, I\'m coming...', "pd": '-Y', "at": '+Y'}, # 27
    {"tones": ['PF007'], "name": 'Separate ways'}, # 28
...
livePitty = [
    {"tones": ['CD006', 'PF001', 'CD029'], "name": 'Teto de vidro', "pd": 'SW', "at": '+Y'}, # 01
    {"tones": ['PF001'], "name": 'Máscara', "pd": 'VOL', "at": '+Y'}, # 02
    {"tones": ['PF001'], "name": 'Admirável chip...', "pd": '-Y', "at": '+Y'}, # 03
    {"tones": ['PF000', 'PF003'], "name": 'Equalize', "pd": '-Y', "at": '+Y'}, # 04
    {"tones": ['CD022', 'PF001'], "name": 'Anacrônico', "pd": '-Y', "at": '+Y'}, # 05
    {"tones": ['PF000', 'CD029'], "name": 'Memórias', "pd": '-Y', "at": '+Y'}, # 06
    {"tones": ['PF000', 'CD029'], "name": 'Déjà vu', "pd": '-Y', "at": '+Y'}, # 07
    {"tones": ['CD001PM'], "name": 'Na sua estante', "pd": '-Y', "at": '+Y'}, # 08
    {"tones": ['PF000', 'CD029'], "name": 'Me adora', "pd": '-Y', "at": '+Y'}, # 09
    {"tones": ['PF004', 'PF003', 'PF001'], "name": 'Eu quero sempre...', "pd": '-Y', "at": '+Y'}, # 10
    {"tones": ['CD029'], "name": 'Semana que vem', "pd": '-Y', "at": '+Y'}, # 11
    {"tones": ['PF000'], "name": 'I wanna be', "pd": '-Y', "at": '+Y'}, # 12
    {"tones": ['PF004', 'PE039'], "name": 'Temporal', "pd": '-Y', "at": '+Y'}, # 13
    {"tones": ['PF000'], "name": 'Emboscada', "pd": '-Y', "at": '+Y'}, # 14
    {"tones": ['PF000'], "name": 'Pulsos', "pd": '-Y', "at": '+Y'}, # 15
    
    {"tones": ['PF000', 'PF001', 'PF003', 'PF004'], "name": 'Don\'t speak', "pd": '-Y', "at": '+Y'}, # 16
    {"tones": ['CD026'], "name": 'Take on me', "pd": '-Y', "at": '+Y'}, # 17
    {"tones": ['CD031'], "name": 'Everybody wants...', "pd": '-Y', "at": '+Y'}, # 18
    {"tones": ['PF001'], "name": 'Nothing else m...', "pd": '-Y', "at": '+Y'}, # 19
    {"tones": ['CD001PM'], "name": 'Zombie', "pd": '-Y', "at": '+Y'}, # 20
    {"tones": ['PF011', 'CD029'], "name": 'Man in the box', "pd": '-Y', "at": '+Y'}, # 21
    {"tones": ['PF001', 'CD029'], "name": 'Heaven and hell', "pd": '-Y', "at": '+Y'}, # 22
    {"tones": ['CD000', 'PF001', 'PF013'], "name": 'I want out', "pd": '-Y', "at": '+Y'}, # 23
    {"tones": ['PF001', 'CD001PM', 'PF000'], "name": 'Wasting love', "pd": '-Y', "at": '+Y'}, # 24
    {"tones": ['CD022PP', 'CD022PM'], "name": 'Perfect strangers', "pd": '-Y', "at": '+Y'}, # 25
    {"tones": ['PF001'], "name": 'Toxicity', "pd": '-Y', "at": '+Y'}, # 26
    {"tones": ['PF007'], "name": 'Jump', "pd": '-Y', "at": '+Y'}, # 27
    {"tones": ['PF000'], "name": 'Jeremy', "pd": '-Y', "at": '+Y'}, # 28
    {"tones": ['PF008', 'PF006', 'PF001', 'PF000'], "name": 'Tears of the...', "pd": '-Y', "at": '+Y'}, # 29
    {"tones": ['CD024', 'PA092'], "name": 'Mama, I\'m coming...', "pd": '-Y', "at": '+Y'}, # 30
    {"tones": ['CD001', 'PF001'], "name": 'Bring me to life', "pd": '-Y', "at": '+Y'}, # 31
]
...
refugio_20210820 = [
    ...
    {"tones": ['PF000', 'PF003'], "name": 'Equalize', "pd": 'SW'}, # 18
    {"tones": ['PF008', 'PF000'], "name": 'Love ain\'t no...', "pd": 'SW'}, # 19
    {"tones": ['CD001', 'PF001'], "name": 'Bring me to life', "pd": 'SW'}, # 20
    {"tones": ['PF001', 'CD001'], "name": 'Toxicity'}, # 21
    # Parte 2    
    {"tones": ['CD018'], "name": 'The final count...'}, # 22
    {"tones": ['PF007'], "name": 'Jump'}, # 23
...
generals = {"name":'General Tones',"tones":['CD001','PF001','PF000','CD000'],"pd":'-Y',"at":'+Y'}
